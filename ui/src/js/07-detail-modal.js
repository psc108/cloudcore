...
function openDetail(type, resource) {
  ...
  const fieldMap = {
    ...
    instance: () => [['ID', resource.id], ['Image', resource.image_id], ['Flavor', resource.flavor], ['Private IP', resource.private_ip || '—'], ['SSH', sshDisplay(resource)], ['Status', resource.status], ['Created', fmtDate(resource.created_at)]],
