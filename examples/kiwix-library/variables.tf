...
# Leave blank to keep the kiwix instance local (the default -- unchanged
...
variable "peer_id" {
  description = "ID of a paired remote peer to place the kiwix instance on instead of the local host. Requires peer_vpc_id/peer_subnet_id/peer_security_group_id to also be set."
  type        = string
  default     = ""
}

variable "peer_vpc_id" {
  description = "The peer's own VPC ID for the kiwix instance — only meaningful when peer_id is set."
  type        = string
  default     = ""
}

variable "peer_subnet_id" {
  description = "The peer's own subnet ID for the kiwix instance — only meaningful when peer_id is set."
  type        = string
  default     = ""
}
...
variable "peer_security_group_id" {
  description = "The peer's own security group ID for the kiwix instance — required when peer_id is set."
  type        = string
  default     = ""
}
