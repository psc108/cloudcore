module github.com/cloudcore/terraform-provider-cloudcore/tests

go 1.25.8

require (
	github.com/cloudcore/terraform-provider-cloudcore v0.0.0
...
replace github.com/cloudcore/terraform-provider-cloudcore => ../../provider
